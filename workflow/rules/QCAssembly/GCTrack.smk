...
rule create_gc_track: #
    ...
    output:
        gap_bedgraph=out_dir_path / "{assembly_stage, [^/]+}/{parameters, [^/]+}/assembly_qc/{track_type, gc}/{haplotype, [^.]+}/{genome_prefix, [^/]+}.{assembly_stage}.{haplotype}.{track_type}.win{window, [0-9]+}.step{step, [0-9]+}.track.bedgraph",
    log:
