...
rule maskfasta: #
    ...
    output:
        ...
        merged_bed="{fasta_dir}/{fasta_prefix}/masking/{fasta_prefix}.repeats.track.bed",
    log:
        std="{fasta_dir}/log/maskfasta.{fasta_prefix}.log",
        cluster_log="{fasta_dir}/log/maskfasta.{fasta_prefix}.cluster.log",
        cluster_err="{fasta_dir}/log/maskfasta.{fasta_prefix}.cluster.err"
    benchmark:
        "{fasta_dir}/log/maskfasta.{fasta_prefix}.benchmark.txt"
    conda:
