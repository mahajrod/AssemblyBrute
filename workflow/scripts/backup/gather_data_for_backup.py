...
backup_dir = results_dir_path / "backup/"
...
for folder_path in kmer_dir_path.glob("*"):
    ...
    backup_kmer_datatype_path = backup_dir / "kmer/" / kmer_datatype / "filtered/"
    ...
    shutil.copy(genomescope_dir_path, backup_kmer_datatype_path)
