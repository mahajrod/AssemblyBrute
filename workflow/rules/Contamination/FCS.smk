...
rule fcs_adaptor: #
    priority: 2000
    input:
        fasta=out_dir_path / out_dir_path / "contig/{parameters}/{genome_prefix}.contig.{haplotype}.unfiltered.fasta", #"contig/{parameters}/{genome_prefix}.contig.{haplotype}.lenfiltered.fasta",
        #db=lambda wildcards: config["allowed_databases"]["fcs"][wildcards.database]["path"],
