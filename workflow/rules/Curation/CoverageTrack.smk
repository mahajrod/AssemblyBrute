...
rule draw_coverage_heatmap:
    ...
    output:
        png=out_dir_path / "curation/{prev_stage_parameters}..{curation_parameters}/{haplotype, ^[./]+}/input/{genome_prefix}.input.{haplotype}.{datatyp, ^[./]+}.coverage.win{window}.step{step}.png",
