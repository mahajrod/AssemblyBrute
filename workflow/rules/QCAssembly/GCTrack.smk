...
rule create_gc_track: #
    ...
    output:
        gc_bedgraph=out_dir_path / "{assembly_stage, [^/]+}/{parameters, [^/]+}/assembly_qc/tracks/{haplotype, [^.]+}/{genome_prefix, [^/]+}.{assembly_stage}.{haplotype}.{track_type, gc}.win{window, [0-9]+}.step{step, [0-9]+}.track.bedgraph",
    log:
