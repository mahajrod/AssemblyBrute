...
rule pretext_inject_tracks:
    ...
    shell:
        ...
        "                       workflow/scripts/curation/filter_bed_by_scaffolds.py -d {input.filtered_out} -i ${{BUSCO_TRACK}}.{wildcards.subset}.tmp  | "
        ...
        "                       workflow/scripts/curation/filter_bed_by_scaffolds.py -d {input.filtered_out} -i ${{PURGE_DUPS_TRACK}}.{wildcards.subset}.tmp  | "
