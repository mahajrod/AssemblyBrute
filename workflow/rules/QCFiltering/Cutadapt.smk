...
rule cutadapt:
    ...
    params:
        ...
        forward_anywhere_adapters= lambda wildcards: (" -b " + " -b ".join(parameters["tool_options"]["cutadapt"][wildcards.datatype]["forward_anywhere_adapter_list"])) if ("forward_anywhere_adapter_list" in parameters["tool_options"]["cutadapt"][wildcards.datatype]) and parameters["tool_options"]["cutadapt"][wildcards.datatype]["forward_anywhere_adapter_list"] else "",
        reverse_anywhere_adapters= lambda wildcards: (" -B " + " -B ".join(parameters["tool_options"]["cutadapt"][wildcards.datatype]["reverse_anywhere_adapter_list"])) if ("reverse_anywhere_adapter_list" in parameters["tool_options"]["cutadapt"][wildcards.datatype]) and parameters["tool_options"]["cutadapt"][wildcards.datatype]["reverse_anywhere_adapter_list"] else "",
        forward_three_prime_adapters= lambda wildcards: (" -a " + " -a ".join(parameters["tool_options"]["cutadapt"][wildcards.datatype]["forward_three_prime_adapter_list"])) if ("forward_three_prime_adapter_list" in parameters["tool_options"]["cutadapt"][wildcards.datatype]) and parameters["tool_options"]["cutadapt"][wildcards.datatype]["forward_three_prime_adapter_list"] else "",
        reverse_three_prime_adapters= lambda wildcards: (" -A " + " -A ".join(parameters["tool_options"]["cutadapt"][wildcards.datatype]["reverse_three_prime_adapter_list"])) if ("reverse_three_prime_adapter_list" in parameters["tool_options"]["cutadapt"][wildcards.datatype]) and parameters["tool_options"]["cutadapt"][wildcards.datatype]["reverse_three_prime_adapter_list"] else "",
        forward_five_prime_adapters= lambda wildcards: (" -g " + " -g ".join(parameters["tool_options"]["cutadapt"][wildcards.datatype]["forward_five_prime_adapter_list"])) if ("forward_five_prime_adapter_list" in parameters["tool_options"]["cutadapt"][wildcards.datatype]) and parameters["tool_options"]["cutadapt"][wildcards.datatype]["forward_five_prime_adapter_list"] else "",
        reverse_five_prime_adapters= lambda wildcards: (" -G " + " -G ".join(parameters["tool_options"]["cutadapt"][wildcards.datatype]["reverse_five_prime_adapter_list"])) if ("reverse_five_prime_adapter_list" in parameters["tool_options"]["cutadapt"][wildcards.datatype]) and parameters["tool_options"]["cutadapt"][wildcards.datatype]["reverse_five_prime_adapter_list" ] else "",
    log:
