...
rule busco5: # Downloading of busco datasets is performed by a different rule to avoid conflict between different instances of busco5
    ...
    output:
        tar_gz="{fasta_dir}/assembly_qc/busco5/{fasta_prefix}.{busco5_lineage}.busco5.tar.gz",
        summary="{fasta_dir}/assembly_qc/busco5/{fasta_prefix}.{busco5_lineage}.busco5.summary",
        summary_json="{fasta_dir}/assembly_qc/busco5/{fasta_prefix}.{busco5_lineage}.busco5.summary.json",
        busco_table="{fasta_dir}/assembly_qc/busco5/{fasta_prefix}.{busco5_lineage}.busco5.full_table.tsv",
        missing_busco_ids="{fasta_dir}/assembly_qc/busco5/{fasta_prefix}.{busco5_lineage}.busco5.missing.ids",
    params:
