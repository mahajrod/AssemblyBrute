...
single_sided_mapped_reads = format(single_sided_mapped_reads,",d")
table.append(["Single Side Mapped Read Pairs", single_sided_mapped_reads, f"{percent_single_sided_mapped}%"])
