...
use rule porechop_abi as porechop_abi_ext_data with:
    input:
    ...
    log:
        porechop_abi=config["out_dir"] / "log/porechop_abi_ext_data.{nanopore_datatype}.{track_name}.trimmed.{fileprefix}.porechop_abi.log",
        cluster_log=config["out_dir"] / "log/porechop_abi_ext_data.{nanopore_datatype}.{track_name}.trimmed.{fileprefix}.cluster.log",
        cluster_err=config["out_dir"] / "log/porechop_abi_ext_data.{nanopore_datatype}.{track_name}.trimmed.{fileprefix}.cluster.err"
    benchmark:
        config["out_dir"] / "log/porechop_abi_ext_data.{nanopore_datatype}.{track_name}.trimmed.{fileprefix}.benchmark.txt"
...
use rule chopper as chopper_ext_data with:
    input:
    ...
    log:
        zcat=config["out_dir"] / "log/chopper_ext_data.{nanopore_datatype}.{track_name}.filtered.{fileprefix}.zcat.log",
        chopper=config["out_dir"] / "log/chopper_ext_data.{nanopore_datatype}.{track_name}.filtered.{fileprefix}.chopper.log",
        pigz_filtered=config["out_dir"] / "log/chopper_ext_data.{nanopore_datatype}.{track_name}.filtered.{fileprefix}.pigz_filtered.log",
        cluster_log=config["out_dir"] / "log/chopper_ext_data.{nanopore_datatype}.{track_name}.filtered.{fileprefix}.cluster.log",
        cluster_err=config["out_dir"] / "log/chopper_ext_data.{nanopore_datatype}.{track_name}.filtered.{fileprefix}.cluster.err"
    benchmark:
        config["out_dir"] / "log/chopper_ext_data.{nanopore_datatype}.{track_name}.filtered.{fileprefix}.benchmark.txt"