...
rule trf: #
    ...
    output:
        simple_bed="{fasta_dir}/{fasta_prefix}/repeats/{fasta_prefix}.trf.simple.bed",
    ...
    log:
        std="{fasta_dir}/log/trf.{fasta_prefix}.trf.log",
        cluster_log="{fasta_dir}/log/trf.{fasta_prefix}.trf.cluster.log",
        cluster_err="{fasta_dir}/log/trf.{fasta_prefix}.trf.cluster.err"
    benchmark:
        "{fasta_dir}/log/trf.{fasta_prefix}.trf.benchmark.txt"
    conda:
