...
rule tidk_search:
    ...
    shell:
        ...
        "   mv ${{CANNONICAL_OUT_PREFIX}}_telomeric_repeat_windows.bedgraph {output.canonical_tidk_bedgraph}; "
        "   else"
        ...
        "   mv ${{NON_CANNONICAL_OUT_PREFIX}}_telomeric_repeat_windows.bedgraph {output.non_canonical_tidk_bedgraph}; "
        "   else "
